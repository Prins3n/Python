...
"""
Brukfunksjonenfraoppgave1oglageilistemedselvvalgtlengde.Finnminimumsverdi.
...
print(min(get_lengde(8))) #bruker min funskjonen til å sreturnere det elementet i lista med lavest verdi.